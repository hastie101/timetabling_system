            ...
            <div class="form-group">  
                ...
                <select name="CourseID" class="form-control" required>  
                    ...
                    @foreach($courses as $course)  
                        <option value="{{ $course->id }}">{{ $course->name }}</option> <!-- Adjust accordingly to your course attributes -->  
                    @endforeach  
                </select>  
            </div>  
            ...
            <div class="form-group">  
                ...
                <select name="InstructorID" class="form-control" required>  
                    ...
                    @foreach($instructors as $instructor)  
                        <option value="{{ $instructor->id }}">{{ $instructor->name }}</option> <!-- Adjust accordingly to your instructor attributes -->  
                    @endforeach  
                </select>  
            </div>  
